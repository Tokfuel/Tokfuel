...
運用・検証の手順は [`handbook/README.md`](../handbook/README.md)（索引は [`README.md`](../README.md)）。

## 一覧

Tokfuel のアーキテクチャ決定の全体像。新規 ADR を追加・状態を変えたら、この表も同じ PR で更新する。

| 番号 | タイトル | 状態 | 要約 | リンク |
|------|----------|------|------|--------|
| 0001 | アプリ関連を App/ 配下に集約する | Accepted | 本体と `App/Tests/`（UT/IT/TestDocs/E2E）の親を `App/` に固定する | [0001-app-tree.ja.md](0001-app-tree/0001-app-tree.ja.md) |
...
```text
Docs/adr/
  README.md / README.ja.md           # この説明と一覧
  TEMPLATE/                          # 新規 ADR の雛形
...
例: `Docs/adr/0001-app-tree/0001-app-tree.md` と `0001-app-tree.ja.md`
...
6. この README の一覧表に 1 行追加する（[English](README.md) の表も同様）
